...
from forwarder.proxy.mode_servers import LocalRedirectorInstance
from forwarder.proxy.mode_servers import ServerInstance
from forwarder.proxy.mode_servers import WireGuardServerInstance
from forwarder.proxy.server import ConnectionHandler
...
async def test_transparent(failure, monkeypatch, caplog_async):
    ...
    if failure:
        ...
        monkeypatch.setattr(
            forwarder.platform, "original_addr", lambda s: ("address", 42)
        )
