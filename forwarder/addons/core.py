...
from forwarder import optmanager
...
class Core:
    ...
    def mark(self, flows: Sequence[flow.Flow], marker: forwarder.types.Marker) -> None:
        """
        Mark flows.
        """
        updated = []
    ...
    @command.argument("attr", type=forwarder.types.Choice("flow.set.options"))
    ...
    @command.argument("encoding", type=forwarder.types.Choice("flow.encode.options"))
    def encode(
        self,
    ...
    def options_load(self, path: forwarder.types.Path) -> None:
        """
    ...
    def options_save(self, path: forwarder.types.Path) -> None:
        """
