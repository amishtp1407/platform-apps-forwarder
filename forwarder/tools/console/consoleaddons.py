...
from forwarder import contentviews
...
class ConsoleAddon:
    ...
    def console_choose(
        ...
        cmd: forwarder.types.Cmd,
        *args: forwarder.types.CmdArgs,
    ) -> None:
        """
    ...
    def console_choose_cmd(
        self,
        prompt: str,
        choicecmd: forwarder.types.Cmd,
        subcmd: forwarder.types.Cmd,
        *args: forwarder.types.CmdArgs,
    ) -> None:
        """
    ...
    @command.argument("part", type=forwarder.types.Choice("console.bodyview.options"))
    ...
    @command.argument(
        "flow_part", type=forwarder.types.Choice("console.edit.focus.options")
    )
    ...
    def grideditor_load(self, path: forwarder.types.Path) -> None:
        """
    ...
    def grideditor_load_escaped(self, path: forwarder.types.Path) -> None:
        """
    ...
    def grideditor_save(self, path: forwarder.types.Path) -> None:
        """
    ...
    @command.argument(
        "mode", type=forwarder.types.Choice("console.flowview.mode.options")
    )
