...
import forwarder.tools.console.master
...
from forwarder.tools.console import common
from forwarder.tools.console import flowdetailview
from forwarder.tools.console import layoutwidget
from forwarder.tools.console import searchable
from forwarder.tools.console import tabs
...
class FlowViewHeader(urwid.WidgetWrap):
    def __init__(
        self,
        master: "forwarder.tools.console.master.ConsoleMaster",
    ) -> None:
        self.master = master
        self.focus_changed()
...
class FlowDetails(tabs.Tabs):
    ...
    @property
    def flow(self) -> forwarder.flow.Flow:
