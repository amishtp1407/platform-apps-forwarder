...
from forwarder.tools.console import commandexecutor
...
from forwarder.tools.console.commander import commander
...
class ActionBar(urwid.WidgetWrap):
    def __init__(self, master: forwarder.tools.console.master.ConsoleMaster) -> None:
        self.master = master
