...
from forwarder.tools import cmdline
from forwarder.utils import arg_check
from forwarder.utils import debug
...
def forwarder(args=None) -> int | None:  # pragma: no cover
    from forwarder.tools import dump
    ...
    run(dump.DumpMaster, cmdline.forwarder, args, extra)
    return None